...
model_urls = {('unet', 'R231'): ('https://github.com/amrane99/lungmask/releases/download/v0.0/unet_r231-d5d2fc3d.pth', 3),
              ('unet', 'LTRCLobes'): (
                  'https://github.com/amrane99/lungmask/releases/download/v0.0/unet_ltrclobes-3a07043d.pth', 6),
              ('unet', 'R231CovidWeb'): (
                  'https://github.com/amrane99/lungmask/releases/download/v0.0/unet_r231covid-0de78a7e.pth', 3)}
